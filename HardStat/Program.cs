...
Console.WriteLine();
Console.WriteLine("Индекс максимального элемента: " + rez[0]); //Индекс первого в массиве максимального элемнта
Console.WriteLine("Значение максимального элемента: " + rez[1]);
Console.WriteLine("Индекс минимального элемента: " + rez[2]); //Индекс первого в массиве минимального элемнта
Console.WriteLine("Значение максимального элемента: " + rez[3]);
